...
console.log(`
$T = (Invoke-RestMethod 'http://localhost:3001/api/v1/auth/login' -Method POST -ContentType 'application/json' -Body '{"email":"demo_user_1@gkc.edu.tw","password":"Demo1234"}').token
